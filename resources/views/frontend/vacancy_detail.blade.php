...
<style>
    ...
    .bg-light-success { background: rgba(25, 135, 84, 0.05); }
    .job-rich-content ul, .job-rich-content ol { padding-left: 1.25rem; margin-bottom: 1.5rem; }
    .job-rich-content p { margin-bottom: 1.25rem; }
    .sparkle-btn {
        transition: all 0.3s;
...
<style>
    .hover-primary:hover { color: var(--primary-theme) !important; text-decoration: underline !important; }
</style>
