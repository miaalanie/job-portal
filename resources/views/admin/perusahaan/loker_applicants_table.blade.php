{{-- resources/views/admin/perusahaan/loker_applicants_table.blade.php --}}
{{-- Ini HANYA isi tabel — di-render server-side lalu di-inject via AJAX --}}
                    ...
                    <td class="ps-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <span class="text-gray-800 fw-bold fs-6">{{ $pelamar->namalengkap ?? 'Tidak Ada Data' }}</span>
                                <span class="text-muted fw-semibold fs-8">{{ $pelamar->alamatlengkap ?? '-' }}</span>
                            </div>
                        </div>
                    </td>
