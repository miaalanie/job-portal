            ...
            <div class="row g-9 mb-8">
                ...
                <div class="row g-9 mb-8">
                    <div class="col-md-4 fv-row">
                        ...
                        @else
                        <label class="fs-7 fw-bold text-gray-500 mb-1 d-block">Status Aktif</label>
                        <span class="badge badge-light-{{ $event->statusaktif ? 'success' : 'secondary' }} fw-bold">
                            {{ $event->statusaktif ? 'Aktif' : 'Tidak Aktif (menunggu approval Superadmin)' }}
                        </span>
                        @endif
                    </div>
                    <div class="col-md-4 fv-row">
